...
import type { ServiceApiDoc } from '@/redux/api/serviceMyListingApi'

interface ListingCardProps {
  listing: ServiceApiDoc
  onDelete: (listing: ServiceApiDoc) => void
}
      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        ...
        <div className="mt-auto flex gap-2">
          <Button
            ...
            onClick={() => navigate(`/my-service-listing/${listing._id}/edit`)}
          >
            Edit
          </Button>
          <Button
